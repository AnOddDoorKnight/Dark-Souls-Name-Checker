...
partial record BlockList
{
	...
	public static readonly Dictionary<Game, byte> lengths = new()
	{
		[Game.Ds3] = 16,
	};
	public static readonly Dictionary<Game, string[]> disallowedTerms = new()
	{
		[Game.Ds3] = new string[]
		{
			"69",
